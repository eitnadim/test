...
public class RfidElement {
	 ...
	 * @param tagType
	 */
	public RfidElement(int age, byte alarmByte, int id, byte reedSwitchCounter, byte repeatRate, int siteCode,
			byte tagType, int signalStrength) {
		setAge(age);
	...
	public String toString() {
		return "[Age=" + getAge() + "] [Alarm byte=" + getAlarmByte() + "] [Id=" + getId() + "] [Read switch counter="
				+ getReedSwitchCounter() + "] [Repeat rate=" + getRepeatRate() + "] [Site code=" + getSiteCode()
	...
	public boolean equals(Object arg0) {
		if (arg0 instanceof RfidElement) {
			...
			if (getAge() == rfidData.getAge() && getAlarmByte() == rfidData.getAlarmByte()
					&& getId() == rfidData.getId() && getReedSwitchCounter() == rfidData.getReedSwitchCounter()
					&& getRepeatRate() == rfidData.getRepeatRate() && getSiteCode() == rfidData.getSiteCode()
					&& getTagType() == rfidData.getTagType() && getSignalStrength() == rfidData.getSignalStrength()) {
				return true;
			}
		}
