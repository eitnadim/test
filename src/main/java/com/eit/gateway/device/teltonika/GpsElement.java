...
public class GpsElement {
	...
	/**
	 * Direction in degrees, 0 equals north, increasing clockwise (45 equals north
	 * east)
	 */
	 ...
	 * 
	 * @param x          X coordinate in WGS format multiplied by WGS_PRECISION
	 * @param y          Y coordinate in WGS format multiplied by WGS_PRECISION
	 ...
	 * @throws IllegalAccessException If any of passed parameters is illegal, see
	 *                                setters
	 */
	...
	/**
	 * @return Returns direction in degrees, 0 equals north, increasing clockwise
	...
	/**
	 * @param angle Direction in degrees, 0 equals north, increasing clockwise (45
	 *              equals north east)
	...
	/**
	 * @param y Y coordinate in WGS format, multiplied by WGS_PRECISION y to set.
	 * @throws IllegalArgumentException If y is less than -90 * WGS_PRECISION and
	 *                                  greater than 90 * WGS_PRECISION
	 */
	public void setY(int y) {
		if (y < -90 * WGS_PRECISION || y > 90 * WGS_PRECISION) {
			throw new IllegalArgumentException(
					"Acceptable y value is [" + (-90 * WGS_PRECISION) + ".." + (90 * WGS_PRECISION) + "] " + y);
		}
		this.y = y;
	}
	...
	/**
	 * @param x X coordinate in WGS format, multiplied by WGS_PRECISION
	 * @throws IllegalArgumentException If x is less than -180 * WGS_PRECISION and
	 *                                  greater than 180 * WGS_PRECISION
	 */
	public void setX(int x) {
		if (x < -180 * WGS_PRECISION || x > 180 * WGS_PRECISION) {
			throw new IllegalArgumentException(
					"Acceptable x value is [" + (-180 * WGS_PRECISION) + ".." + (180 * WGS_PRECISION) + "] " + x);
		}
		this.x = x;
	}
	...
	public String toString() {
		return "[X=" + getX() + "] [Y=" + getY() + "] [Speed=" + getSpeed() + "] [Angle=" + getAngle() + "] [Altitude="
				+ altitude + "] [Satellites=" + getSatellites() + "]";
	}
	 ...
	 * @throws IOException Thrown by passed input stream, or if unable to read gps
	 ...
	 */
	/*
	 * public int hashCode() { return getX() + getY() + getSpeed() +
	 * getSatellites(); }
	 */
