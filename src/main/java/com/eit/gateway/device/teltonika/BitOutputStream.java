 ...
 *         <p>
 *         This class allows to write bits to it and later retrieve byte array
 *         with written bits. Retrieved array can be user with BitInputStream to
 *         read written bits.
 *         </p>
 */
public class BitOutputStream extends OutputStream {
	 ...
	 *              Maximum bits to write is 64 if this value is greater than 64 it
	 *              is assigned 64 anyway
