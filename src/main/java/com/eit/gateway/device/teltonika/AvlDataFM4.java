...
//			int eventSourceId = 0xFF & codecInputStream.read();
			...
			int eventSourceId = geteventSourceFromData(codecInputStream);
...
//			AvlDataFM4 ret = new AvlDataFM4(timestamp, gpsData, iodata, priority, eventSourceId);
			...
			return new AvlDataFM4(timestamp, gpsData, iodata, priority, eventSourceId);
			
		}
	}
	
	protected int geteventSourceFromData(BitInputStream codecInputStream) throws IOException {
		return 0xFF & codecInputStream.read();
	}
	...
	public String toString() {
		return "FM4 [Priority=" + getPriority() + "] [GPS element=" + getGpsElement() + "] [IO="
