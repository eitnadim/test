...
public class BitInputStream extends InputStream {
	 ...
	 * 
	 * @param bits Number of bits to read. Maximum bits that can be read in one time
	 *             is number of bits in long data typs i.e. 64. If this value is
	 *             greater value of only 64 bits will be returned
	 * @return Read bits as long value. If for instance 3 bits are read and first is
	 *         0 next is 1 and last is 1 returned value will be long value
	 *         representing binary number 110
	 */
