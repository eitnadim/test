...
public class AvlDataGH extends AvlData {
	...
	public static final int CELLID_PROPERTY_ID = 200;
	public static final int SIGNAL_QUALITY_PROPERTY_ID = 201;
	public static final int OPCODE_PROPERTY_ID = 202;

	// GlobalMask values
	protected static final int MASK_GPS_ELEMENT = 0x01;
	protected static final int MASK_IO_ELEMENT_1B = 0x01 << 1;
	protected static final int MASK_IO_ELEMENT_2B = 0x01 << 2;
	protected static final int MASK_IO_ELEMENT_4B = 0x01 << 3;

	// Mask values
	protected static final int MASK_POSITION = 0x01;
	protected static final int MASK_ALTITUDE = 0x01 << 1;
	protected static final int MASK_ANGLE = 0x01 << 2;
	protected static final int MASK_SPEED = 0x01 << 3;
	protected static final int MASK_SATELLITES = 0x01 << 4;
	protected static final int MASK_CELLID = 0x01 << 5;
	protected static final int MASK_SIGNALQUALITY = 0x01 << 6;
	protected static final int MASK_OPERATOR_CODE = 0x01 << 7;
	 ...
	 * @param priority
	 */
	public AvlDataGH(long timestamp, GpsElement gpsElement, IOElement ioElement, byte priority) {
...
//		AvlDataGH ret = new AvlDataGH(cal.getTimeInMillis() + timestamp * 1000L, gpsElement, ioElement, priority);
	...
	/**
	 * @param is
	 * @param generatedProperties - if not null, in this method it can be filled
	 *                            with generated propeties (which desn't fit into
	 *                            GpsElement)
	...
	public String toString() {
		return "GH [Priority=" + getPriority() + "] [GPS element=" + getGpsElement() + "] [IO="
				+ getInputOutputElement() + "] [Timestamp=" + getTimestamp() + "]";
	}
